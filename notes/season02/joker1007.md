...
- ラジオネーム「expajp（えくすぱ）」さん「jokerさんは大学は文系学部で、就職後も趣味でコードを書いていた期間が長かったそうですが、プログラミングを始めたきっかけとハマったきっかけを教えてください・jokerさんは黒魔術師としての印象が強いですが、黒魔術の開発はプロダクトやgemの開発で必要に迫られて行っているのでしょうか？それとも、黒魔術開発自体を目的にしてるりまを眺めたりされているのでしょうか？・ジョジョ5部アニメのハイライトを3つ教えてください」
  - 3つあるので1つずつ聞く
